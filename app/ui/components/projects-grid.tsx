  ...
  return (
    ...
    <div className="mt-5 grid grid-cols-1 gap-6 md:grid-cols-4">
      {projects.map((project: any) => {
        ...
        <div
          key={project.id}
          className="rounded-md border-2 border-solid p-5 transition-transform duration-200 ease-out transform hover:scale-105 hover:shadow-lg hover:ring-2 hover:ring-indigo-200 hover:bg-white/5 cursor-pointer"
        >
          <img
            src={project.src}
            width={project.width}
