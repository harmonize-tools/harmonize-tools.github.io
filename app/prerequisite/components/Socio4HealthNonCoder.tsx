...
source venv/bin/activate`}</code></pre>
        ...
        <pre className="mt-2 bg-gray-50 border rounded p-3 overflow-x-auto"><code className="language-python">{`streamlit run Home.py --server.maxUploadSize=1GB`}</code></pre>
        <img
          src="/img/image.png"
