...
export default function Clim4HealthCoder({ os }: { os?: OS }) {
  const isLinux = os === 'linux';

  return (
    <article className="mt-4 rounded-lg bg-white p-6 shadow-sm">
      <header>
        <h1 className="page-title text-2xl font-extrabold mb-2">clim4health</h1>
      ...
      <div className="page-body text-gray-800">
        ...
        <details className="group mt-4 mb-4 border rounded">
          <summary className="flex items-center justify-between cursor-pointer px-4 py-3 bg-gray-50 hover:bg-gray-100">
            <h2 id="get-tutorial-docker-image" className="text-lg font-semibold">Get the tutorial docker image</h2>
            <span className="text-gray-600">▸</span>
          </summary>
          <div className="p-4">
            <OsTabs
